...
public final class EnterpriseTopComponent extends TopComponent implements ActionListener,
    ...
    public void update() {
        ...
        String parent ;
        String director ;
        String logo = enterprisePanel.getTabelEnterprise().getValueAt(4, 1).toString().trim();
        String slogan = enterprisePanel.getTabelEnterprise().getValueAt(5, 1).toString().trim();
