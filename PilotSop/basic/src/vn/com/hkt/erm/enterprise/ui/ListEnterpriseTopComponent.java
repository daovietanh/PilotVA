...
public final class ListEnterpriseTopComponent extends TopComponent implements ActionListener, MouseListener,
    ...
    public void loadData() {
        ...
        for (Enterprise bean : list) {
            ...
            Object[] rows = {bean.getEnterpriseName(), bean.getEnterpriseID(), enterprise, person1, bean.getLogo(), bean.getSlogan()};
            model.addRow(rows);
        }
        listEnterprisePanel.getTableListE().setModel(model);
        setupTable();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (button == buttonSave) {
            ...
            String logo = listEnterprisePanel.getTableListE().getValueAt(row, 4).toString().trim();
            String slogan = listEnterprisePanel.getTableListE().getValueAt(row, 5).toString().trim();
            Enterprise bean = new Enterprise(id, name, parent, director, logo, slogan);
