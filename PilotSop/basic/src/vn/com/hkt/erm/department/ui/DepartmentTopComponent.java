...
public final class DepartmentTopComponent extends TopComponent implements ActionListener, ResetCookieList, Observer, Observable {
    ...
    public void save() {
        ...
        if (departmentPanel.getTableD().getValueAt(2, 1) != null) {
            if (departmentPanel.getTableD().getValueAt(2, 1).toString().trim().length() != 0) {
                ...
                enter = enterprise.getEnterpriseID().trim();
            } else {
                enter = departmentPanel.getTableD().getValueAt(2, 1).toString().trim();
            }
        } else {
            enter = " ";
        }
        ...
        if (departmentPanel.getTableD().getValueAt(6, 1) != null) {
            if (departmentPanel.getTableD().getValueAt(6, 1).toString().trim().length() != 0) {
                Product product = (Product) departmentPanel.getTableD().getValueAt(6, 1);
                spdv = product.getProductID().trim();
            } else {
                spdv = departmentPanel.getTableD().getValueAt(6, 1).toString().trim();
            }
        } else {
            spdv = " ";
        }
        ...
        if (departmentPanel.getTableD().getValueAt(5, 1) != null) {
            if (departmentPanel.getTableD().getValueAt(5, 1).toString().trim().length() != 0) {
                Department department = (Department) departmentPanel.getTableD().getValueAt(5, 1);
                duan_me = department.getDepartmentParent().trim();
            } else {
                duan_me = departmentPanel.getTableD().getValueAt(5, 1).toString().trim();
            }
        } else {
            duan_me = " ";
        }
        ...
        if (departmentPanel.getTableD().getValueAt(3, 1) != null) {
            if (departmentPanel.getTableD().getValueAt(3, 1).toString().trim().length() != 0) {
                Person person1 = (Person) departmentPanel.getTableD().getValueAt(3, 1);
                person = person1.getPersonID().trim();
            } else {
                person = departmentPanel.getTableD().getValueAt(3, 1).toString().trim();
            }
    ...
    public void update() {
        ...
        if (departmentPanel.getTableD().getValueAt(5, 1) != null) {
            if (departmentPanel.getTableD().getValueAt(5, 1).toString().trim().length() != 0) {
                Department department = (Department) departmentPanel.getTableD().getValueAt(5, 1);
                duan_me = department.getDepartmentID().trim();
            } else {
                duan_me = departmentPanel.getTableD().getValueAt(5, 1).toString().trim();
            }
        } else {
