...
public final class ProductTopComponent extends TopComponent implements ActionListener, ResetCookieList, Observable, Observer {
    ...
    public void save() {
        ...
        String person ;
        String nhomsp ;
         if (productPanel.getTableProduct().getValueAt(2, 1) != null) {
            if (productPanel.getTableProduct().getValueAt(2, 1).toString().trim().length() != 0) {
                Enterprise enterprise = (Enterprise) productPanel.getTableProduct().getValueAt(2, 1);
                cty = enterprise.getEnterpriseID().trim();
            } else {
                cty = productPanel.getTableProduct().getValueAt(2, 1).toString().trim();
            }
        } else {
            cty = " ";
        }
        ...
        if (productPanel.getTableProduct().getValueAt(5, 1) != null) {
            if (productPanel.getTableProduct().getValueAt(5, 1).toString().trim().length() != 0) {
                Product product = (Product) productPanel.getTableProduct().getValueAt(5, 1);
                nhomsp = product.getProductID().trim();
            } else {
               nhomsp = productPanel.getTableProduct().getValueAt(5, 1).toString().trim();
            }
        } else {
            nhomsp = " ";
        }
        ...
        if (productPanel.getTableProduct().getValueAt(3, 1) != null) {
            if (productPanel.getTableProduct().getValueAt(3, 1).toString().trim().length() != 0) {
                ...
                bophan = productPanel.getTableProduct().getValueAt(3, 1).toString().trim();
            }
        } else {
            bophan = " ";
        }
        ...
        if (productPanel.getTableProduct().getValueAt(4, 1) != null) {
            if (productPanel.getTableProduct().getValueAt(4, 1).toString().trim().length() != 0) {
                ...
                person = productPanel.getTableProduct().getValueAt(4, 1).toString().trim();
            }
