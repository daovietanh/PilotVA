...
public class CreateAccount extends javax.swing.JDialog {
    ...
    DefaultComboBoxModel modelGroup, modelPerson, modelCompany;
    private IPersonBN personDAO;
    private IDepartmentBN departmentDAO;
...
//        int i;
//        for (i = 1; i <= 10; i++) {
//            Row row = new Row("Row " + i, "Value " + i, "Extra " + i);
//            modelCompany.addElement(row);
//        }
//        cbxCompany.setModel(modelCompany);
//        cbxCompany.setRenderer(new RowCellRenderer());
//        cbxCompany.setEditable(true);
//        new JComboBoxFilterAPI(cbxCompany);

        this.personDAO = Lookup.getDefault().lookup(IPersonBN.class);
        this.departmentDAO = Lookup.getDefault().lookup(IDepartmentBN.class);
